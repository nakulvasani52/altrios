...
def plot_full_4panel(sim_df, geo_df, xlim, train_info):
    ...
    # Shared y-axis limits for cross-simulation comparison
    RES_YLIM = (-2000, 3000)   # kN – covers both NB & SB extremes
    DEMAND_YLIM = (-2500, 2500)  # kN – covers both NB & SB extremes
