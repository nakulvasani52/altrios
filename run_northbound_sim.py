...
# Northbound: Start at beginning of Link 1 (Consolidated), End at Link 1 (Consolidated)
...
tsb = alt.TrainSimBuilder(
    train_id="Henderson_NB_Passenger",
    train_config=train_config,
    loco_con=consist,
)

# Create simulation
print("Creating Northbound Passenger Simulation (242 -> 252)...")
...
output_file = "results/henderson_nb_simulation.csv"
df_focused.to_csv(output_file, index=False)

# Summary stats
print("\n" + "="*60)
print("NORTHBOUND PASSENGER SIMULATION COMPLETE")
print("="*60)
